            ...
            <div class="col-md-8">
                <div class="card rounded">
                    ...
                    <div class="card-body">
                        ...
                        <form action="/update_hasil_id/{{$hasil->id_hasil}}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="space_id" value="{{$hasil->space_id}}"class="form-control @error('space_id') is-invalid @enderror" id="" style="display:none">
                             ...
                             <input type="text"  value="{{$hasil->getData?->slug}}" name="slug" class="form-control @error('slug') is-invalid @enderror"  style="display:none" id="" > 
                            ...
                            <div class="form-group mt-3">
                                <a href="/map/{{$hasil->getData?->slug}}" class="btn btn-info btn-sm">Kembali</a>
