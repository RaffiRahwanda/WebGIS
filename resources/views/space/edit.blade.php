                    ...
                    <div class="card-body">
                        <form action="{{ route('space.update',$space) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="sungai" value="{{ $space->sungai_id }}" class="form-control @error('name') is-invalid @enderror" id="" style="display:none">
                                <input type="text" name="sungais" value="{{ $space->getNameSungais?->nama_sungai }}" class="form-control @error('name') is-invalid @enderror" id="" disabled>
                                @error('name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group mb-3">
                                <label for="">Foto Tempat</label><br>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea name="content" class="form-control @error('content') is-invalid @enderror" id="" cols="30" rows="10" placeholder="Deskripsi">{{ $space->content }}</textarea>
                                @error('content')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group mt-3">
                                   <a href="{{ route('space.index') }}" class="btn btn-info btn-sm">Kembali</a>
